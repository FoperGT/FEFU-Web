...
const lastNames = [
    'García', 'Martínez', 'Rodríguez', 'López', 'Hernández', 'Pérez', 'González', 'Gómez', 'Sánchez', 'Díаz',
...
const allPlayers = clubs.flatMap(club => generatePlayers(club, numPlayersPerClub));
